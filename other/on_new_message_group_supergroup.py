...
from handlers_group.on_new_message_from_creator import on_new_message_from_creator_group
from handlers_group.on_new_message_from_admin import on_new_message_from_admin_group
from handlers_group.on_new_message_from_member import on_new_message_from_member_group
...
async def on_new_message_group_supergroup(message: Message) -> Coroutine:
    ...
    if chat_member_status == 'creator':
        return await on_new_message_from_creator_group(message)
    elif chat_member_status == 'administrator':
        return await on_new_message_from_admin_group(message)
    elif chat_member_status == 'member':
        return await on_new_message_from_member_group(message)
